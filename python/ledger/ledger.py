...
def format_entries(currency, locale, entries):
    if locale == 'en_US':
        ...
        while len(entries) > 0:
            ...
            table += "%02d/%02d/%04d" % (entry.date.month,entry.date.day,entry.date.year)
            table += ' | '
            ...
            if len(entry.description) > 25:
                ...
                table += ' ' * (25- len(entry.description))
        ...
        while len(entries) > 0:
            ...
            # Write entry date to table
            table += "%02d-%02d-%04d" % (entry.date.day,entry.date.month,entry.date.year)
            table += ' | '
